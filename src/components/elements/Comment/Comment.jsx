        ...
        <div className="testimon-comment">
            <div className="testimon-comment-box">
                <div className="testimon-rating">
                    {(rating) > 0 && <i class="bi bi-star-fill" ></i>}
                    {(rating) > 1 && <i class="bi bi-star-fill" ></i>}
                    {(rating) > 2 && <i class="bi bi-star-fill" ></i>}
                    {(rating) > 3 && <i class="bi bi-star-fill" ></i>}
                    {(rating) > 4 && <i class="bi bi-star-fill" ></i>}
                </div>
                ...
                <div className="testimon-comment-profile-wrapper">
                    <div className="testimon-profile-img">
                        <img className="testimon-profile-img-source" src={avatarUrl} />
                    </div>
